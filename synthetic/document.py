...
DEFAULT_DOCUMENT_HEIGHT = None
DOCUMENT_HEIGHT_RANGE = (1192//4, 2176)
...
BLUR_RADIUS_RANGE = (0.2, 0.4*5)
LINE_OPACITY_RANGE = (180, 255)
LINE_STD_GAUSSIAN_NOISE_RANGE = (4, 40)
LINE_WIDTH_RANGE = (1, 4)

BLACK_AND_WHITE_FREQ = 0.2
