...
from .. import SYNTHETIC_RESRC_PATH


# resource names
BACKGROUND_RESRC_NAME = "background"
FONT_RESRC_NAME = "font"
FONT_TYPES = ["arabic", "chinese", "handwritten", "normal", "number", "greek", "hebrew", "foreign_like"]
...
GREEK_TEXT_RESRC_NAME = "text_greek"
HEBREW_TEXT_RESRC_NAME = "text_hebrew"
...
VALID_EXTENSIONS = {
    ...
    GREEK_TEXT_RESRC_NAME: ["txt"],
    HEBREW_TEXT_RESRC_NAME: ["txt"],
}
                ...
                for font in FONT_TYPES:
                    if font == "number":
                        files = get_files_from_dir(
                            p / 'normal', valid_extensions=ext, recursive=True
                        )
                    else:
                        files = get_files_from_dir(
