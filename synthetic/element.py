...
import pickle
import os 
dictionnary_category_ability_paths = os.path.join(SYNTHETIC_RESRC_PATH, 'new_dictionnary_category_ability_paths.pkl')

dictionnary_category_ability_paths = pickle.load(open(dictionnary_category_ability_paths,'rb'))
...
GAUSSIAN_NOISE_STD_RANGE = (2*2, 10*10)
